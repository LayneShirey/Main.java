...
public class RPSLSpock {
    ...
    /**
     * isValidPick method
     * @param pick - the users choice
     * @return checks to see if pick is valid as a boolean answer
     */
    ...
    /**
     * generatePick  method
     * @return generates the computer pick as a string
     */
     ...
     * @return tells if the computer is winning as a boolean answer
     */
